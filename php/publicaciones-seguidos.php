...
$uId = $_SESSION['id'];
$sql =
    "SELECT * FROM publications p LEFT JOIN users u ON u.id = p.userId
    WHERE p.userId IN(SELECT userToFollowId FROM follows where users_id = $uId)
    ORDER BY p.id DESC;";
...
<body>
    <div class="container">
        ...
        <main>
            <div class="post-menu botones-primarios">
            ...
            <section class="publicaciones-usuarios">
                ...
                ?>
                        <div class="card">
                            <div class="card-body">
                                <a href="../php/userPerfil.php?userId=<?php echo $userId; ?>"></a>
                                <?php
